...
const ProductCard = ({product}) => {
    const {title,category,price_max,_id} = product
    return (
        <div>
    ...
    <div class="flex flex-col gap-1 mt-4 px-4">
      ...
      <span class="font-normal text-gray-600 dark:text-gray-300">{category}</span>
      <span class="font-semibold text-gray-800 dark:text-gray-50">{price_max} TK</span>
    </div>
    ...
    <div class="mt-4 p-4 border-t border-gray-200 dark:border-gray-500">
      <Link to={`/productDetails/${_id}`} class="w-full flex justify-between items-center font-bold cursor-pointer hover:underline text-gray-800 dark:text-gray-50">
