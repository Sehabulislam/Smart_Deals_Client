...
const ProductDetails = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto shadow-md py-8 rounded-2xl">
            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="px-2">
                <button
                  ...
                  className="w-full bg-linear-to-bl from-violet-500 to-fuchsia-500 text-white py-2 px-4 rounded-full font-bold cursor-pointer"
                >
            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="flex mb-4">
                <div className="mr-4">
                  ...
                  <span className="">{price_max} Tk</span>
                </div>
                <div>
          ...
          <div className="modal-box">
            ...
            <section className="w-full max-w-md">
              <div className="rounded-none bg-white p-8">
                ...
                {/*  Form*/}
                <form onSubmit={handleBidProduct} className="space-y-6">
